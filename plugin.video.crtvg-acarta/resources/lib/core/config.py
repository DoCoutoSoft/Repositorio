...
print "crtvg.core.config PLATFORM_NAME="+ PLATFORM_NAME

PLUGIN_NAME = "crtvg-acarta"
...
print "crtvg-acarta.core.config runtime path = "+get_runtime_path()
print "crtvg-acarta.core.config data path = "+get_data_path()
print "crtvg-acarta.core.config temp path = "+get_temp_file("test")